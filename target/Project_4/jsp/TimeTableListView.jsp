<%@page import="com.raystec.Model.TimeTableModel"%>
...
<%@page import="com.raystec.Bean.TimetableBean"%>
...
<body >
<jsp:useBean id="bean" class="com.raystec.Bean.TimetableBean" scope="request"></jsp:useBean>
